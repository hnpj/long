		...
		<div class="ForumPageTableBorder" style="margin-top: 25px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr align="center" valign="middle">
					...
					<td width="270" class="ForumPageTableTitle">最后发表</td>
				</tr>
					...
					<tr height="78" align="center" class="template">
						...
						<td class="ForumPageTableDataLine">
							<ul class="ForumPageTopicUl">
								<li class="ForumPageTopic"><html:link action="/ForumAction?method=show&id=${forum.id}" styleClass="ForumPageTopic">${forum.name}</html:link></li>
						...
						<td class="ForumPageTableDataLine">
							<ul class="ForumPageTopicUl">
								<li><font color="#444444">┌ 主题：</font> 
									<html:link action="/TopicAction?method=show?id=${forum.lastTopic.id}" styleClass="ForumTitle">${forum.lastTopic.title}</html:link>
								</li>
