...
<!-- 显示表单 -->
<html:form action="/UserAction?method=login" focus="loginName">
    <div id="CenterAreaBg">
        <div id="CenterArea">
                ...
                <table BORDER=0 CELLSPACING=0 CELLPADDING=0 width=100%>
                    ...
                    <tr>
                        ...
                        <td rowspan="2" style="padding-left:10px;">
                        	<html:image tabindex="3" src="${pageContext.request.contextPath}//style/blue/images/login/userLogin_button.gif" />
                        </td>
                    </tr>
                    <tr>
