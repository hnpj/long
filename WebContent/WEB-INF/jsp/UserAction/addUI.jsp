					...
					<div class="ItemBlock">
						<table cellpadding="0" cellspacing="0" class="mainForm">
							...
							<tr>
								...
								<td>
									<html:text property="loginName"
										styleClass="InputStyle {required:true, remote:'${pageContext.request.contextPath}/UserAction.do?method=checkLoginName', messages:{remote:'登录名已存在，请更换！'}}"></html:text>
									* （登录名要唯一）
								</td>
							</tr>
							<tr>
								...
								<td>
									<html:text property="name" styleClass="InputStyle"></html:text>
									*
								</td>
							</tr>
							<tr>
								...
								<td>
									<html:radio property="sex" value="男" styleId="male" />
									<label for="male">
										男
									</label>
									<html:radio property="sex" value="女" styleId="female" />
									<label for="female">
										女
									</label>
								</td>
							...
							<tr>
								...
								<td>
									<html:text property="phoneNumber" styleClass="InputStyle"></html:text>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<html:text property="email" styleClass="InputStyle"></html:text>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<html:textarea property="description" styleClass="TextareaStyle"></html:textarea>
								</td>
							</tr>
						</table>
					</div>
					...
					<div class="ItemBlock">
						<table cellpadding="0" cellspacing="0" class="mainForm">
							<tr>
								...
								<td>
									<html:select property="roleIdList" multiple="true" size="10" styleClass="SelectStyle">
